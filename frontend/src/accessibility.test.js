...
describe('mobile accessibility and layout contracts', () => {
  ...
  it('keeps mobile workout summaries, dates, and exercise progress readable', () => {
    ...
    const stats = source('views/Stats.jsx')
    const ui = source('components/ui.jsx')
    expect(workout).toContain('className="history-date-control"')
    expect(workout).toContain('className="history-date-input"')
    expect(workout).toContain('type="date"')
    expect(css).toContain('.history-date-control:focus-within')
    expect(css).toContain('appearance:none;-webkit-appearance:none')
