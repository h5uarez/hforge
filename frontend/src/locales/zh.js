...
export default {
  ...
  'Remove exercise?': '移除动作？',
  'Remove “{0}” from this active workout? The saved routine will not change.': '从本次训练中移除“{0}”？已保存的训练计划不会改变。',
  'Pick an icon': '选择图标',
  ...
  'Exercise removed from workout': '已从训练中移除动作',
  ...
  'Estimate assumes a barbell compound; isolation lifts vary more.': '该预估假设为杠铃复合动作；孤立动作差异更大。',
  'HIGH': '高',
  'MEDIUM': '中',
  'unreliable': '不可靠',
  'Calcular': '计算',
  // --- Home warmup card ---
  'Warmup calculator': '热身计算器',
  'Show warmup calculator': '显示热身计算器',
  'Estimate warmup sets on the Home screen.': '在首页预估你的热身组。',
  'Configure warmup': '配置热身',
  'Warmup sets': '热身组',
  'Main set': '正式组',
  'Bench press': '卧推',
  'Squat': '深蹲',
  ...
  'Rest {0}s': '休息 {0} 秒',
  'Empty bar': '空杆',
  'Added weight ({0})': '附加重量（{0}）',
  'Save your strength for the top set.': '为正式组保存体力。',
  'No warmup needed — go straight to the top set.': '无需热身——直接进入正式组。',
  'Time': '时间',
  'Seconds': '秒数',
  ...
  'no such code': 'no such code',
   ...
   'not found': 'not found',
    ...
    'session id required': '需要会话 ID',
    'deadline required': '需要截止时间',
    'unsupported locale': '不支持的语言',
    'active workout push requires HTTPS or localhost': '动态训练推送需要 HTTPS 或 localhost',
    'active push subscription required': '需要有效的推送订阅',
}
