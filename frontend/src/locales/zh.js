...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Hforge locally on this device.": '此浏览器不支持通行密钥——你仍可在本设备上本地使用 Hforge。',
  ...
  'Rest timer': '休息计时',
   ...
   'Bodyweight check before workouts': '训练前检查体重',
   'Ask for your bodyweight before every workout.': '每次训练前询问体重。',
  'Sounds': '声音',
  ...
  'to install Hforge as a full-screen app.': '即可将 Hforge 安装为全屏应用。',
  ...
  'Rest-timer alerts, even if Hforge is closed.': '休息计时提醒，即使 Hforge 已关闭。',
  ...
  'A small file a friend imports into their own Hforge — routines only, none of your workouts or weigh-ins.': '一个小文件，朋友可以导入到自己的 Hforge——只有训练日，不包含你的训练记录或体重。',
  ...
  'Set {0}': '第 {0} 组',
  'Show programmed target': '显示预设目标',
  'Hide programmed target': '隐藏预设目标',
  'Target': '目标',
  'read-only': '只读',
  ...
  'Previous week': 'Previous week', 'Next week': 'Next week', 'Move up': 'Move up', 'Move down': 'Move down', 'Clear': 'Clear', 'Decrease': 'Decrease', 'Increase': 'Increase', 'Decrease {0}': 'Decrease {0}', 'Increase {0}': 'Increase {0}', 'minus 0.1': 'minus 0.1', 'plus 0.1': 'plus 0.1', 'delete': 'delete', 'Previous month': 'Previous month', 'Next month': 'Next month',
   ...
   'Export': '导出', 'Export workouts': '导出训练', 'Select workout days to export': '选择要导出的训练日', 'No days selected': '未选择日期', '{0} day selected': '已选择 {0} 天', '{0} days selected': '已选择 {0} 天', 'Clear selection': '清除选择', 'Export JSON': '导出 JSON', 'Select {0}': '选择 {0}', 'Deselect {0}': '取消选择 {0}', 'Only days with workouts can be selected.': '只能选择有训练记录的日期。', 'Select at least one workout day to export.': '至少选择一个训练日才能导出。', 'Exporting…': '正在导出…', 'Export failed': '导出失败',
  }
