...
export default {
  ...
  'A new version of Hforge is ready.': 'Hay una nueva versión de Hforge lista.',
  'Update now': 'Actualizar ahora',
  'A new version is ready — finish your workout first, then reload to apply it.': 'Hay una nueva versión lista — termina tu entrenamiento primero y recarga para aplicarla.',
  'Reload anyway': 'Recargar igualmente',
  ...
  'Enter a valid whole number of seconds': 'Introduce un número entero válido de segundos',
  // --- admin ---
  ...
  // --- localized push & server errors (popup-notifications-spanish) ---
   ...
   'Push notifications require HTTPS or localhost': 'Las notificaciones push requieren HTTPS o localhost',
