...
export default {
  'Add exercise notes': 'Añadir notas de ejercicios', 'Edit exercise note': 'Editar nota del ejercicio', 'Optional note for this workout. You can add context to each exercise.': 'Nota opcional para este entrenamiento. Puedes añadir contexto a cada ejercicio.', 'Note for {0}': 'Nota para {0}', 'Note must be 280 characters or fewer.': 'La nota debe tener 280 caracteres o menos.', 'Has note': 'Tiene una nota', 'Note': 'Nota',
  ...
  '{0} week': '{0} semana',
  '{0} weeks': '{0} semanas',
  '{0} block · tap to manage': '{0} bloque · toca para gestionar',
  '{0} blocks · tap to manage': '{0} bloques · toca para gestionar',
  'Block saved': 'Bloque guardado',
  'Block updated': 'Bloque actualizado',
  'End the active block first': 'Termina primero el bloque activo',
  'Activate block?': '¿Activar bloque?',
  '{0} becomes your schedule from today. You can pause or end it later.': '{0} será tu planificación desde hoy. Puedes pausarlo o finalizarlo más tarde.',
  'Activate': 'Activar',
  'Block activated': 'Bloque activado',
  'End the block before deleting': 'Termina el bloque antes de eliminarlo',
  'Delete block?': '¿Eliminar bloque?',
  'Removes the block definition. Workouts you already started keep their snapshot.': 'Elimina la definición del bloque. Los entrenamientos que ya has comenzado conservan su instantánea.',
  'Block deleted': 'Bloque eliminado',
  'New block': 'Nuevo bloque',
  'Edit block': 'Editar bloque',
  'Name your block and pick a routine or rest for every weekday of every week.': 'Pon un nombre al bloque y elige una rutina o descanso para cada día de la semana de todas las semanas.',
  ...
  'Fix these to save': 'Corrige estos errores para guardar',
  'Save & activate': 'Guardar y activar',
  'Update': 'Actualizar',
  'Training blocks': 'Bloques de entrenamiento',
  'A block is an ordered sequence of weeks, each with a routine or rest for every weekday. Activate one to make it your schedule.': 'Un bloque es una secuencia ordenada de semanas, cada una con una rutina o descanso para cada día. Activa uno para usarlo como tu planificación.',
  '(deleted block)': '(bloque eliminado)',
  'Paused': 'Pausado',
  'Active': 'Activo',
  'Pause block?': '¿Pausar bloque?',
  'Paused days do not advance the block position. You can resume later.': 'Los días en pausa no avanzan la posición del bloque. Puedes reanudarlo más tarde.',
  'Pause': 'Pausar',
  'Block paused': 'Bloque pausado',
  'Resume block?': '¿Reanudar bloque?',
  'Resumes the block from its current position.': 'Reanuda el bloque desde su posición actual.',
  'Block resumed': 'Bloque reanudado',
  'End block?': '¿Finalizar bloque?',
  'Ends the active block and keeps all started workouts. The definition is preserved.': 'Finaliza el bloque activo y conserva todos los entrenamientos iniciados. La definición se mantiene.',
  'End block': 'Finalizar bloque',
  'Block ended': 'Bloque finalizado',
  'No blocks yet.': 'Aún no hay bloques.',
  'Build one to schedule multiple weeks of training at once.': 'Crea uno para programar varias semanas de entrenamiento a la vez.',
  'Add block': 'Añadir bloque',
  'Final week': 'Última semana',
  'Pause failed: {0}': 'No se pudo pausar: {0}',
  'Resume failed: {0}': 'No se pudo reanudar: {0}',
  'End failed: {0}': 'No se pudo finalizar: {0}',
  'block is missing': 'Falta el bloque',
  'block name is blank': 'El nombre del bloque está vacío',
  'block has no weeks': 'El bloque no tiene semanas',
