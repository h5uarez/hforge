...
export default {
  ...
  'Cancel': 'Cancelar',
  'Retry': 'Reintentar', 'Undo': 'Deshacer',
  'Could not save your workout': 'No se pudo guardar tu entrenamiento',
  'Your changes are still visible. Choose an action to recover.': 'Tus cambios siguen visibles. Elige una acción para recuperarlos.',
  'Delete': 'Eliminar',
  'Save': 'Guardar',
  'Import': 'Importar',
  'Discard': 'Descartar',
  ...
  'Add from another routine': 'Añadir desde otra rutina',
  'Choose a saved routine to append all of its exercises to this workout.': 'Elige una rutina guardada para añadir todos sus ejercicios a este entrenamiento.',
  'Add exercises from another routine': 'Añadir ejercicios de otra rutina',
  'Add its exercises to the end of this workout. Your saved routine will not change.': 'Añade sus ejercicios al final de este entrenamiento. Tu rutina guardada no cambiará.',
  'Add routine to workout?': '¿Añadir rutina al entrenamiento?',
  'All {0} exercises from “{1}” will be appended to the end of this workout. Their configuration, progression and supersets will be kept. Your saved routine will not change.{2}': 'Los {0} ejercicios de «{1}» se añadirán al final de este entrenamiento. Se conservarán su configuración, progresión y superseries. Tu rutina guardada no cambiará.{2}',
  'Some exercise IDs overlap existing entries, so duplicates will still be added intentionally.': 'Algunos ejercicios ya están en esta sesión; se añadirán de nuevo igualmente.',
  ...
  'We detected {0} max.': 'Detectamos un máximo de {0}.',
  'Some completed sets have no weight yet.': 'Algunas series completadas aún no tienen peso.',
  'Above the usual {0} range — saved with the TopWeight range.': 'Por encima del rango habitual de {0} — se guarda con el rango TopWeight.',
  'Save': 'Guardar',
  ...
  'Search…': 'Buscar…',
  'Filters': 'Filtros',
  'Try a shorter name — “press” finds every press there is.': 'Prueba con un nombre más corto — «press» encuentra todos los ejercicios de press.',
  ...
  'Profile created — data from this device moved into it': 'Perfil creado — datos trasladados',
  ...
  'Change how your name appears across the app.': 'Cambia cómo aparece tu nombre en la app.',
  ...
  "This browser doesn't support passkeys — you can still use Hforge locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar Hforge localmente en este dispositivo.',
  ...
  'Could not sign out everywhere — you are still signed in.': 'No se pudo cerrar todo — sigues con sesión.',
  ...
  'Light': 'Claro',
  'Palette': 'Paleta',
  'Recolors backgrounds, surfaces and accents': 'Recolorea fondos, superficies y acentos',
  'Palettes now recolor the whole app, not just accents.': 'Las paletas ahora recolorean toda la app, no solo los acentos.',
  'General': 'General',
  ...
  'Rest timer': 'Temporizador de descanso',
   'Enable rest timer': 'Activar temporizador de descanso',
   'Bodyweight check before workouts': 'Chequeo de peso corporal antes de entrenar',
   'Ask for your bodyweight before every workout.': 'Pedir tu peso corporal antes de cada entrenamiento.',
   'Workout view': 'Vista del entrenamiento',
   'Choose how exercises are shown while training.': 'Elige cómo se muestran los ejercicios durante el entrenamiento.',
   'Extended': 'Extendida',
   'Compact': 'Compacta',
   'Workout compaction': 'Compactación del entrenamiento',
  'Show each exercise as a circle and open its video and instructions in a popup.': 'Muestra cada ejercicio en un círculo y abre su vídeo e instrucciones en una ventana.',
  'Sounds': 'Sonidos',
  ...
  'Adds historical workouts and weigh-ins without replacing current data.': 'Añade entrenamientos y pesajes históricos sin reemplazar los datos actuales.',
  'Backup imported': 'Copia importada',
  'Import failed: {0}': 'Importación fallida: {0}',
  'A new version of Hforge is ready.': 'Nueva versión lista.',
  'Update now': 'Actualizar',
  'A new version is ready — finish your workout first, then reload to apply it.': 'Termina tu serie y recarga.',
  'Reload anyway': 'Recargar',
  '{0} workouts are already imported and will be skipped.': 'Ya hay {0} entrenamientos importados y se omitirán.',
  'Notifications': 'Notificaciones',
  'Not supported in this browser.': 'No compatible con este navegador.',
  'Push notifications': 'Notificaciones push',
  'Rest-timer alerts, even if Hforge is closed.': 'Avisos del temporizador de descanso, incluso con Hforge cerrado.',
  ...
  'Test sent — should arrive any second': 'Prueba enviada — llega en segundos',
  'Test failed': 'Prueba fallida',
  'Notifications off': 'Notificaciones desactivadas',
  'Notifications on': 'Notificaciones activadas',
  'Could not change notification settings': 'No se pudo guardar el cambio',
  ...
  'upper arms': 'brazos', 'upper legs': 'piernas', 'waist': 'abdomen', 'full body': 'cuerpo completo', 'other': 'otro',
  'Details': 'Detalles',
  'Finish': 'Terminar',
  'Start {0}': 'Empezar {0}',
  'Start workout?': '¿Empezar entrenamiento?',
  'Start {0}? You can log sets as you go.': 'La sesión de {0} quedará en marcha y podrás registrar las series sobre la marcha.',
  'Start {0}? Pick exercises as you go.': 'Se abrirá una sesión libre ({0}) y podrás elegir los ejercicios sobre la marcha.',
  'Start your first workout': 'Empezar tu primer entrenamiento',
  // Platform biometry names interpolated into login copy (see lib/api.js BIO).
  'your fingerprint, face or PIN': 'tu huella, tu cara o el PIN',
  'fingerprint or face unlock': 'la huella o el desbloqueo facial',
  ...
  'plate': 'disco', 'suspension': 'suspensión', 'other': 'otro',
  ...
  'Exercise removed from workout': 'Ejercicio eliminado del entrenamiento',
  ...
  'Description (optional) — setup, cues, anything you want to remember': 'Descripción (opcional) — preparación, consejos, lo que quieras recordar',
    'Trainer note': 'Nota del entrenador',
    'Exercise note': 'Nota del ejercicio',
   'Show {0}': 'Mostrar {0}',
   'Hide {0}': 'Ocultar {0}',
   'Optional instructions or context for this exercise.': 'Instrucciones o contexto opcionales para este ejercicio.',
  ...
  'Minimize': 'Minimizar',
  'Expand': 'Ampliar',
  'Open video and instructions for {0}': 'Abrir el vídeo y las instrucciones de {0}',
  ...
  'That file\'s columns aren\'t recognised — see the docs for supported apps.': 'Columnas no reconocidas — consulta la documentación.',
  ...
  'A small file a friend imports into their own Hforge — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio Hforge: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Plan file saved — send it to a friend': 'Plan guardado — envíaselo a un amigo',
  '{0}’s plan': 'Plan de {0}',
  'Import “{0}”': 'Importar «{0}»',
  ...
  '{0}RM': '{0}RM',
  'Show 1RM calculator': 'Mostrar calculadora 1RM', 'Show estimated 1RM table': 'Mostrar tabla de 1RM estimado',
  'Estimate one-rep max on the Home screen.': 'Estima tu repetición máxima en la pantalla de inicio.',
  ...
  'Show warmup calculator': 'Mostrar calculadora de aproximaciones',
  'Estimate warmup sets on the Home screen.': 'Calcula tus series de aproximación en la pantalla de inicio.',
  'Configure warmup': 'Configurar aproximaciones',
  'Warmup sets': 'Series de aproximación',
  ...
  'Rounding': 'Redondeo',
  'Pace': 'Ritmo',
  'Deadlift mode': 'Modo peso muerto',
  ...
  'Advanced': 'Avanzado',
  'Singles': 'Singles',
  'With reps': 'Con repeticiones',
  'Rest {0}s': 'Descanso {0} s',
  'Empty bar': 'Barra vacía',
  ...
  'Generic reps': 'Repeticiones genéricas',
  'Set-specific values override Generic reps.': 'Los valores específicos por serie sustituyen las repeticiones genéricas.',
  ...
  'No programmed target': 'Sin objetivo programado',
  'Target': 'Objetivo',
  ...
  // --- demo, self-hosting & rest timer ---
  'Live demo — everything stays in this browser.': 'Demo en directo: todo se queda en este navegador.',
  'Start the demo': 'Empezar la demo',
  'This demo runs entirely in your browser on example data — nothing is sent anywhere. Passkey sign-in and sync across your devices come with the Hforge server, which you get by self-hosting it.': 'Esta demo funciona completamente en tu navegador con datos de ejemplo; no se envía nada. El inicio de sesión con passkey y la sincronización entre dispositivos están disponibles con el servidor Hforge que obtienes al alojarlo tú mismo.',
  'Self-host it in a minute →': 'Aloja tu propia instancia en un minuto →',
  'Demo': 'Demo',
  'Self-host Hforge': 'Aloja Hforge tú mismo',
  'Passkey sign-in, sync across your devices, your own data.': 'Inicio de sesión con passkey, sincronización entre dispositivos y tus propios datos.',
  ...
  'Reset demo data': 'Restablecer datos de la demo',
  ...
  'Enable rest timer': 'Activar temporizador de descanso',
  'Automatically and manually timed rests between sets.': 'Descansos entre series cronometrados automáticamente y de forma manual.',
  'Enter a valid whole number of seconds': 'Introduce un número entero de segundos',
  // --- admin ---
  'Loading': 'Cargando', 'Loading…': 'Cargando…', 'User disabled': 'Usuario desactivado', 'User enabled': 'Usuario activado',
  'Disable {0}?': '¿Desactivar a {0}?', 'They are signed out everywhere and can no longer sync or log in until re-enabled.': 'Se cerrará su sesión en todas partes y no podrá sincronizarse ni iniciar sesión hasta que se reactive.', 'Disable': 'Desactivar',
  'Enable account': 'Activar cuenta', 'Disable account': 'Desactivar cuenta', 'Workout history': 'Historial de entrenamientos', 'No workouts logged.': 'No hay entrenamientos registrados.',
  'Invite codes': 'Códigos de invitación', 'Generate': 'Generar', '{0} unused · {1} redeemed': '{0} sin usar · {1} canjeados', 'Code {0} created & copied': 'Código {0} creado y copiado', 'Code revoked': 'Código revocado', 'Copied {0}': '{0} copiado', 'revoke': 'revocar', 'used': 'usado', 'No codes yet — generate one to invite someone.': 'Aún no hay códigos; genera uno para invitar a alguien.',
  'Failed to load': 'No se pudo cargar', 'Back': 'Atrás', 'Admin': 'Administración', '{0} users · {1} active this week': '{0} usuarios · {1} activos esta semana', 'refresh': 'actualizar', 'Users': 'Usuarios', 'Training now': 'Entrenando ahora', 'Active 7d': 'Activos en 7 días', 'Disabled': 'Desactivados', 'push enabled': 'notificaciones push activadas', 'No users yet.': 'Aún no hay usuarios.',
  'Previous week': 'Semana anterior', 'Next week': 'Semana siguiente', 'Move up': 'Mover arriba', 'Move down': 'Mover abajo', 'Clear': 'Borrar', 'Decrease': 'Disminuir', 'Increase': 'Aumentar', 'Decrease {0}': 'Disminuir {0}', 'Increase {0}': 'Aumentar {0}', 'minus 0.1': 'menos 0,1', 'plus 0.1': 'más 0,1', 'delete': 'eliminar', 'Previous month': 'Mes anterior', 'Next month': 'Mes siguiente',
    'never': 'nunca', 'just now': 'justo ahora', 'invite': 'invitado por', 'joined': 'se unió', 'Last sync': 'Última sincronización', 'sets': 'series', 'synced': 'sincronizado',
   'Export': 'Exportar', 'Export workouts': 'Exportar entrenamientos', 'Select workout days to export': 'Selecciona los días de entrenamiento que quieres exportar', 'No days selected': 'No hay días seleccionados', '{0} day selected': '{0} día seleccionado', '{0} days selected': '{0} días seleccionados', 'Clear selection': 'Borrar selección', 'Export JSON': 'Exportar JSON', 'Select {0}': 'Seleccionar {0}', 'Deselect {0}': 'Deseleccionar {0}', 'Only days with workouts can be selected.': 'Solo se pueden seleccionar días con entrenamientos.', 'Select at least one workout day to export.': 'Selecciona al menos un día de entrenamiento para exportar.', 'Exporting…': 'Exportando…', 'Export failed': 'No se pudo exportar',
    'Still there? Your workout awaits.': '¿Sigues ahí? Tu entrenamiento te espera.',
   ...
   'End time must be on or after start time': 'La hora final debe ser posterior a la inicial',
   'Enter valid start and end times': 'Introduce horas de inicio y fin válidas',
  ...
  // --- localized push & server errors (popup-notifications-spanish) ---
   'Push notifications are not supported in this browser': 'Push no compatible con este navegador',
   'Notifications permission was not granted': 'No se concedió el permiso de notificaciones',
   'Push notifications require HTTPS or localhost': 'El push requiere HTTPS o localhost',
   'not signed in': 'No has iniciado sesión',
  'forbidden': 'Acceso denegado',
  'name required': 'Se requiere un nombre',
  'a valid invite code is required': 'Se requiere un código de invitación válido',
  'challenge expired — try again': 'La verificación caducó — inténtalo de nuevo',
  'not verified': 'No se pudo verificar',
  'credential already registered': 'Esta credencial ya está registrada',
  'invite code is no longer valid — ask for a new one': 'Código no válido — pide uno nuevo',
  'unknown passkey — create a profile first': 'Passkey desconocida — crea primero un perfil',
  'user missing': 'No se encuentra el usuario',
  ...
  'seconds required': 'Se requieren los segundos',
  'no such user': 'No existe ese usuario',
  'cannot disable an admin': 'No se puede desactivar a un administrador',
  'no such code': 'No existe ese código',
   'already used — cannot revoke': 'Ya se usó — no se puede revocar',
   'not found': 'No encontrado',
    'server error': 'Error del servidor',
    'invalid request': 'Solicitud no válida',
    'session id required': 'Se requiere el identificador de sesión',
    'deadline required': 'Se requiere la fecha límite',
