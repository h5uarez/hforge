...
export default {
  ...
  'App': 'App',
  'Installed — running full-screen': 'Instalada — a pantalla completa',
  'Install Hforge': 'Instalar Hforge',
  'Full-screen app on your home screen.': 'App a pantalla completa en tu pantalla de inicio.',
  'Installing — check your home screen': 'Instalando — mira tu pantalla de inicio',
  'Install dismissed': 'Instalación cancelada',
  ...
  'Start {0}': 'Empezar {0}',
  'Start workout?': '¿Empezar entrenamiento?',
  'Start {0}? You can log sets as you go.': '¿Empezar {0}? Puedes registrar las series sobre la marcha.',
  'Start {0}? Pick exercises as you go.': '¿Empezar {0}? Elige los ejercicios sobre la marcha.',
