...
export default {
  ...
  'Remove exercise?': 'Egzersizi kaldır?',
  'Remove “{0}” from this active workout? The saved routine will not change.': '“{0}” aktif antrenmandan kaldırılsın mı? Kaydedilen rutin değişmeyecek.',
  ...
  'Exercise removed from workout': 'Egzersiz antrenmandan kaldırıldı',
  ...
  'Estimate assumes a barbell compound; isolation lifts vary more.': 'Tahmin, barbell temel hareket varsayar; izolasyonda daha çok değişir.',
  'HIGH': 'YÜKSEK',
  'MEDIUM': 'ORTA',
  'unreliable': 'güvenilmez',
  'Calcular': 'Hesapla',
  // --- Home warmup card ---
  'Warmup calculator': 'Isınma hesaplayıcı',
  'Show warmup calculator': 'Isınma hesaplayıcıyı göster',
  'Estimate warmup sets on the Home screen.': 'Ana ekranda ısınma setlerini tahmin et.',
  'Configure warmup': 'Isınmayı yapılandır',
  'Warmup sets': 'Isınma setleri',
  'Main set': 'Ana set',
  ...
  'Singles': 'Tekliler',
  'With reps': 'Tekrarlı',
  'Rest {0}s': 'Dinlenme {0} sn',
  'Empty bar': 'Boş bar',
  'Added weight ({0})': 'Ek ağırlık ({0})',
  'Save your strength for the top set.': 'Gücünü ana set için sakla.',
  'No warmup needed — go straight to the top set.': 'Isınmaya gerek yok — doğrudan ana sete geç.',
  'Time': 'Süre',
  'Seconds': 'Saniye',
  ...
  'No programmed target': 'Planlanmış hedef yok',
  'Target': 'Hedef',
  ...
  'no such code': 'no such code',
   ...
   'not found': 'not found',
    ...
    'session id required': 'Oturum kimliği gerekli',
    'deadline required': 'Son tarih gerekli',
    'unsupported locale': 'Desteklenmeyen dil',
    'active workout push requires HTTPS or localhost': 'Aktif antrenman bildirimi HTTPS veya localhost gerektirir',
    'active push subscription required': 'Aktif push aboneliği gerekli',
}
