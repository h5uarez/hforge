...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Hforge locally on this device.": 'Bu tarayıcı geçiş anahtarlarını desteklemiyor — yine de Hforge’i bu cihazda yerel olarak kullanabilirsin.',
  ...
  'Rest timer': 'Dinlenme sayacı',
   ...
   'Bodyweight check before workouts': 'Antrenmanlardan önce vücut ağırlığı kontrolü',
   'Ask for your bodyweight before every workout.': 'Her antrenmandan önce vücut ağırlığınızı sorun.',
  'Sounds': 'Sesler',
  ...
  'to install Hforge as a full-screen app.': 'ile Hforge’i tam ekran uygulama olarak kurabilirsin.',
  ...
  'Rest-timer alerts, even if Hforge is closed.': 'Hforge kapalıyken bile dinlenme sayacı uyarıları.',
  ...
  'A small file a friend imports into their own Hforge — routines only, none of your workouts or weigh-ins.': 'Bir arkadaşının kendi Hforge\'ine aktardığı küçük bir dosya — yalnızca rutinler, antrenmanların veya tartıların değil.',
  ...
  'Set {0}': 'Set {0}',
  'Show programmed target': 'Planlanan hedefi göster',
  'Hide programmed target': 'Planlanan hedefi gizle',
  'Target': 'Hedef',
  ...
  'Previous week': 'Previous week', 'Next week': 'Next week', 'Move up': 'Move up', 'Move down': 'Move down', 'Clear': 'Clear', 'Decrease': 'Decrease', 'Increase': 'Increase', 'Decrease {0}': 'Decrease {0}', 'Increase {0}': 'Increase {0}', 'minus 0.1': 'minus 0.1', 'plus 0.1': 'plus 0.1', 'delete': 'delete', 'Previous month': 'Previous month', 'Next month': 'Next month',
    ...
    'Export': 'Dışa aktar', 'Export workouts': 'Antrenmanları dışa aktar', 'Select workout days to export': 'Dışa aktarılacak antrenman günlerini seç', 'No days selected': 'Hiçbir gün seçilmedi', '{0} day selected': '{0} gün seçildi', '{0} days selected': '{0} gün seçildi', 'Clear selection': 'Seçimi temizle', 'Export JSON': 'JSON’u dışa aktar', 'Select {0}': '{0} seç', 'Deselect {0}': '{0} seçimini kaldır', 'Only days with workouts can be selected.': 'Yalnızca antrenman olan günler seçilebilir.', 'Select at least one workout day to export.': 'Dışa aktarmak için en az bir antrenman günü seç.', 'Exporting…': 'Dışa aktarılıyor…', 'Export failed': 'Dışa aktarma başarısız',
  }
