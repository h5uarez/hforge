...
export default {
  ...
  'Remove exercise?': 'व्यायाम हटाएँ?',
  'Remove “{0}” from this active workout? The saved routine will not change.': 'इस सक्रिय वर्कआउट से “{0}” हटाएँ? सहेजी गई रूटीन नहीं बदलेगी।',
  ...
  'Delete routine': 'रूटीन हटाएँ',
  'Routine deleted': 'रूटीन हटाया गया',
  ...
  'Exercise removed from workout': 'वर्कआउट से व्यायाम हटाया गया',
  ...
  'Estimate assumes a barbell compound; isolation lifts vary more.': 'यह अनुमान बारबेल कंपाउंड मानता है; आइसोलेशन में अंतर ज़्यादा होता है।',
  'HIGH': 'उच्च',
  'MEDIUM': 'मध्यम',
  'unreliable': 'अविश्वसनीय',
  'Calcular': 'गणना करें',
  // --- Home warmup card ---
  'Warmup calculator': 'वॉर्मअप कैलकुलेटर',
  'Show warmup calculator': 'वॉर्मअप कैलकुलेटर दिखाएँ',
  'Estimate warmup sets on the Home screen.': 'होम स्क्रीन पर अपने वॉर्मअप सेट अनुमानित करें।',
  'Configure warmup': 'वॉर्मअप कॉन्फ़िगर करें',
  'Warmup sets': 'वॉर्मअप सेट',
  'Main set': 'मुख्य सेट',
  ...
  'Advanced': 'उन्नत',
  'Singles': 'सिंगल्स',
  'With reps': 'रेप्स सहित',
  'Rest {0}s': 'आराम {0} से',
  'Empty bar': 'खाली बार',
  'Added weight ({0})': 'अतिरिक्त वज़न ({0})',
  'Save your strength for the top set.': 'मुख्य सेट के लिए ताक़त बचाएँ।',
  'No warmup needed — go straight to the top set.': 'वॉर्मअप की ज़रूरत नहीं — सीधे मुख्य सेट पर जाएँ।',
  'Time': 'समय',
  'Seconds': 'सेकंड',
  ...
  'No programmed target': 'कोई निर्धारित लक्ष्य नहीं',
  'Target': 'लक्ष्य',
  ...
  'no such code': 'no such code',
   ...
   'not found': 'not found',
    ...
    'session id required': 'सत्र ID आवश्यक है',
    'deadline required': 'समय-सीमा आवश्यक है',
    'unsupported locale': 'असमर्थित भाषा',
    'active workout push requires HTTPS or localhost': 'सक्रिय वर्कआउट पुश के लिए HTTPS या localhost आवश्यक है',
    'active push subscription required': 'सक्रिय पुश सदस्यता आवश्यक है',
}
