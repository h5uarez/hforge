...
export default {
  ...
  "This browser doesn't support passkeys — you can still use Hforge locally on this device.": 'यह ब्राउज़र पासकी सपोर्ट नहीं करता — फिर भी आप इस डिवाइस पर Hforge लोकली इस्तेमाल कर सकते हैं।',
  ...
  'Rest timer': 'आराम टाइमर',
   ...
   'Bodyweight check before workouts': 'वर्कआउट से पहले शरीर के वजन की जाँच',
   'Ask for your bodyweight before every workout.': 'हर वर्कआउट से पहले अपने शरीर का वजन पूछें।',
  'Sounds': 'ध्वनियाँ',
  ...
  'to install Hforge as a full-screen app.': 'से Hforge को फुल-स्क्रीन ऐप के रूप में इंस्टॉल करें।',
  ...
  'Rest-timer alerts, even if Hforge is closed.': 'आराम टाइमर अलर्ट, Hforge बंद होने पर भी।',
  ...
  'A small file a friend imports into their own Hforge — routines only, none of your workouts or weigh-ins.': 'एक छोटी फ़ाइल जिसे कोई दोस्त अपने Hforge में आयात कर सके — सिर्फ़ रूटीन, आपके वर्कआउट या वज़न नहीं।',
  ...
  'Reload Hforge': 'Hforge फिर से लोड करें',
  ...
  'Set {0}': 'सेट {0}',
  'Show programmed target': 'निर्धारित लक्ष्य दिखाएँ',
  'Hide programmed target': 'निर्धारित लक्ष्य छिपाएँ',
  'Target': 'लक्ष्य',
  ...
  'Previous week': 'Previous week', 'Next week': 'Next week', 'Move up': 'Move up', 'Move down': 'Move down', 'Clear': 'Clear', 'Decrease': 'Decrease', 'Increase': 'Increase', 'Decrease {0}': 'Decrease {0}', 'Increase {0}': 'Increase {0}', 'minus 0.1': 'minus 0.1', 'plus 0.1': 'plus 0.1', 'delete': 'delete', 'Previous month': 'Previous month', 'Next month': 'Next month',
   ...
   'Export': 'निर्यात', 'Export workouts': 'वर्कआउट निर्यात करें', 'Select workout days to export': 'निर्यात करने के लिए वर्कआउट के दिन चुनें', 'No days selected': 'कोई दिन नहीं चुना गया', '{0} day selected': '{0} दिन चुना गया', '{0} days selected': '{0} दिन चुने गए', 'Clear selection': 'चयन साफ़ करें', 'Export JSON': 'JSON निर्यात करें', 'Select {0}': '{0} चुनें', 'Deselect {0}': '{0} का चयन हटाएँ', 'Only days with workouts can be selected.': 'केवल वर्कआउट वाले दिन चुने जा सकते हैं।', 'Select at least one workout day to export.': 'निर्यात करने के लिए कम से कम एक वर्कआउट दिन चुनें।', 'Exporting…': 'निर्यात हो रहा है…', 'Export failed': 'निर्यात विफल',
  }
