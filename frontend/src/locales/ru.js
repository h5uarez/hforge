...
export default {
  ...
  'Cancel': 'Отмена',
  'Retry': 'Повторить', 'Undo': 'Отменить изменение',
  'Could not save your workout': 'Не удалось сохранить тренировку',
  'Your changes are still visible. Choose an action to recover.': 'Ваши изменения всё ещё видны. Выберите действие для восстановления.',
  'Delete': 'Удалить',
  'Save': 'Сохранить',
  'Import': 'Импорт',
  'Discard': 'Отменить',
  ...
  'Remove exercise?': 'Убрать упражнение?',
  'Remove “{0}” from this active workout? The saved routine will not change.': 'Убрать «{0}» из этой активной тренировки? Сохранённая программа не изменится.',
  ...
  'Delete routine': 'Удалить программу',
  'Routine deleted': 'Программа удалена',
  ...
  "This browser doesn't support passkeys — you can still use Hforge locally on this device.": 'Этот браузер не поддерживает ключи доступа — но Hforge можно использовать локально на этом устройстве.',
  ...
  'Rest timer': 'Таймер отдыха',
   ...
   'Bodyweight check before workouts': 'Проверять вес перед тренировкой',
   'Ask for your bodyweight before every workout.': 'Запрашивать ваш вес перед каждой тренировкой.',
  'Sounds': 'Звуки',
  ...
  'Rest-timer alerts, even if Hforge is closed.': 'Оповещения таймера отдыха, даже если Hforge закрыт.',
  ...
  'Exercise removed from workout': 'Упражнение удалено из тренировки',
  ...
  'A small file a friend imports into their own Hforge — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в свой Hforge — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload Hforge': 'Перезагрузить Hforge',
  ...
  'Estimate assumes a barbell compound; isolation lifts vary more.': 'Оценка исходит из базового движения со штангой; на изоляции разброс больше.',
  'HIGH': 'ВЫСОКАЯ',
  'MEDIUM': 'СРЕДНЯЯ',
  'unreliable': 'ненадёжно',
  'Calcular': 'Посчитать',
  // --- Home warmup card ---
  'Warmup calculator': 'Калькулятор разминки',
  'Show warmup calculator': 'Показывать калькулятор разминки',
  'Estimate warmup sets on the Home screen.': 'Оценивай разминочные подходы на главном экране.',
  'Configure warmup': 'Настроить разминку',
  'Warmup sets': 'Разминочные подходы',
  'Main set': 'Основной подход',
  ...
  'Singles': 'Одиночные',
  'With reps': 'С повторами',
  'Rest {0}s': 'Отдых {0} с',
  'Empty bar': 'Пустой гриф',
  'Added weight ({0})': 'Добавленный вес ({0})',
  'Save your strength for the top set.': 'Береги силы для основного подхода.',
  'No warmup needed — go straight to the top set.': 'Разминка не нужна — переходи сразу к основному подходу.',
  'Time': 'Время',
  'Seconds': 'Секунды',
  ...
  'Set {0}': 'Подход {0}',
  'Show programmed target': 'Показать запланированную цель',
  'Hide programmed target': 'Скрыть запланированную цель',
  'No programmed target': 'Нет запланированной цели',
  'Target': 'Цель',
  ...
  'Previous week': 'Previous week', 'Next week': 'Next week', 'Move up': 'Move up', 'Move down': 'Move down', 'Clear': 'Clear', 'Decrease': 'Decrease', 'Increase': 'Increase', 'Decrease {0}': 'Decrease {0}', 'Increase {0}': 'Increase {0}', 'minus 0.1': 'minus 0.1', 'plus 0.1': 'plus 0.1', 'delete': 'delete', 'Previous month': 'Previous month', 'Next month': 'Next month',
   ...
   'Export': 'Экспорт', 'Export workouts': 'Экспорт тренировок', 'Select workout days to export': 'Выберите дни тренировок для экспорта', 'No days selected': 'Дни не выбраны', '{0} day selected': 'Выбран {0} день', '{0} days selected': 'Выбрано дней: {0}', 'Clear selection': 'Очистить выбор', 'Export JSON': 'Экспорт JSON', 'Select {0}': 'Выбрать {0}', 'Deselect {0}': 'Снять выбор: {0}', 'Only days with workouts can be selected.': 'Можно выбрать только дни с тренировками.', 'Select at least one workout day to export.': 'Выберите хотя бы один день тренировки для экспорта.', 'Exporting…': 'Экспорт…', 'Export failed': 'Не удалось экспортировать',
  ...
  'no such code': 'no such code',
   ...
   'not found': 'not found',
    ...
    'deadline required': 'Требуется срок',
    'unsupported locale': 'Язык не поддерживается',
    'active workout push requires HTTPS or localhost': 'Push для активной тренировки требует HTTPS или localhost',
    'active push subscription required': 'Требуется активная push-подписка',
}
