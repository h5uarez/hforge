...
export default {
  ...
  'Remove exercise?': '운동을 제거할까요?',
  'Remove “{0}” from this active workout? The saved routine will not change.': '이 진행 중인 운동에서 “{0}”을(를) 제거할까요? 저장된 루틴은 변경되지 않습니다.',
  'Pick an icon': '아이콘 선택',
  ...
  'Exercise removed from workout': '운동이 트레이닝에서 제거됨',
  ...
  'Estimate assumes a barbell compound; isolation lifts vary more.': '이 추정은 바벨 복합 운동을 가정한 것으로, 고립 운동은 편차가 큽니다.',
  'HIGH': '높음',
  'MEDIUM': '중간',
  'unreliable': '신뢰도 낮음',
  'Calcular': '계산',
  // --- Home warmup card ---
  'Warmup calculator': '웜업 계산기',
  'Show warmup calculator': '웜업 계산기 표시',
  'Estimate warmup sets on the Home screen.': '홈 화면에서 웜업 세트를 추정하세요.',
  'Configure warmup': '웜업 설정',
  'Warmup sets': '웜업 세트',
  'Main set': '메인 세트',
  'Bench press': '벤치프레스',
  'Squat': '스쿼트',
  ...
  'Rest {0}s': '휴식 {0}초',
  'Empty bar': '빈 바',
  'Added weight ({0})': '추가 무게 ({0})',
  'Save your strength for the top set.': '메인 세트를 위해 힘을 아끼세요.',
  'No warmup needed — go straight to the top set.': '웜업 불필요 — 바로 메인 세트로 가세요.',
  'Time': '시간',
  'Seconds': '초',
  ...
  'No programmed target': '계획된 목표 없음',
  'Target': '목표',
  'read-only': '읽기 전용',
  ...
  'no such code': 'no such code',
   ...
   'not found': 'not found',
    ...
    'session id required': '세션 ID가 필요합니다',
    'deadline required': '마감 시간이 필요합니다',
    'unsupported locale': '지원되지 않는 언어',
    'active workout push requires HTTPS or localhost': '진행 중 운동 푸시는 HTTPS 또는 localhost가 필요합니다',
    'active push subscription required': '활성 푸시 구독이 필요합니다',
}
